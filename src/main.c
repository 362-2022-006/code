...
int main() {
    ...
    // puts("\033[97;48;5;21mHello world\033[m");
    // puts("\033[97;48;5;34mHello world\033[m");
    // puts("\033[97;48;5;46mHello world\033[m");
    // puts("\033[97;42mHello world\033[m");
    // puts("\033[97;102mHello world\033[m");
    // puts("\033[97;44mHello world\033[m");
    // puts("\033[97;46mHello world\033[m");
    // puts("\033[97;104mHello world\033[m");
    // puts("\033[97;106mHello world\033[m");

    // puts("a\tbc\td\vef\tghij\tklmnop\t.");
    ...
    // puts("\033[38;2;255;152;0mHello\033[m");
    // puts("\033[38;5;214mHello\033[m");

    // puts("123456789012345678901234567890123456789012345678901234567890");
    // puts("123456789012345678901234567890123456789012345678901234567890");
    // printf("\033[5;9H^\033[2J");
    // puts("*");
    // puts("abcdefghijklmnop\r\t^\033[1J\t&\vabc\b\b\b\033[A\033[K");
    ...
    // puts("\033[48;5;8mHello world 1234567890");
